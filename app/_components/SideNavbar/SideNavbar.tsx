  ...
  return (
    <div>
      <div className="text-left">
        <button
          className="text-white text-3xl rounded-lg mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none"
          type="button"
          ...
          <ul className="space-y-2 font-medium flex-grow">
            ...
            <li>
              ...
              >
                ...
                <span
                  className={` ml-4 whitespace-nowrap ${lang === "ar" ? "" : "flex-1"
                    }`}
                >
